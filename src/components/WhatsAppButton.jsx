...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 left-4 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-200"
    >
